import { parseEther, parseUnits, encodeFunctionData, getAddress, parseAbiItem, encodeAbiParameters, parseAbiParameters, erc20Abi as erc20Abi$1, createWalletClient, http, publicActions } from 'viem';
...
async function getRouteData(fromToken, toToken, fromChain, toChain, amount, fromAddress, slippage = 1) {
  ...
  const response = await axios.get(`${SQUID_BASE_URL}/route`, {
    params,
    headers: getHeaders3()
  });
